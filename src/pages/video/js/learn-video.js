;(function (doc) {
  ...
  MswVideo.prototype = {
    ...
    ifOutRange(sHeight, volumeBarHeight) {
      return sHeight < volumeBarHeight && sHeight > 0
    },

    slideVolumeBar: function (e) {
      
      var e = e || window.event,
          dy = e.pageY, // mousedown时获取
          my = 0,// mouseup时获取
          disY = 0,// y轴拖拽的距离
          sHeight = 0,
          slideHeight = this.oVolumeSlider.offsetHeight, // grey
          volumeBarHeight = this.oVolumeSlideBar.offsetHeight, // active
          _mousemove = _mouseMove.bind(this),
          _mouseup = _mouseUp.bind(this);


          console.log('slideHeight', this.oVolumeSlider, 'volumeBarHeight', this.oVolumeSlideBar)
    ...
    setPlayProgress: function (pageX) {
      console.log('this.videoBox.offsetLeft', this.videoBox.offsetLeft)
